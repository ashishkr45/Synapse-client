...
const Navigation: React.FC<NavigationProps> = ({ isDarkMode, toggleDarkMode }) => {
  ...
  return (
    <div className="w-full flex justify-center pt-4">
      <nav className={`z-50 fixed flex flex-wrap items-center px-4 md:px-8 py-2 rounded-4xl gap-2 md:gap-4 backdrop-blur-md border transition-colors duration-300 ${
        isDarkMode 
          ? 'bg-gray-500/20 border-slate-300/30 text-white' 
          : 'bg-gray-500/20 border-gray-500/30 text-gray-800'
      }`}>
        {/* Logo Section */}
